...
# 4. Agregar búsqueda de forma parcial: Si queremos buscar a un invitado e ingresamos las dos primeras letras de su nombre el programa debería mostrarnos los invitados que tengan esas letras en sus nombres. (Cualquier punto que requiera de una bíusqueda)


# 5. Echarle un vistazo al punto 3 de las consultas ya que no muestra invitados activos, buscar por qué pasa eso.
